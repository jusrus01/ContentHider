...
namespace ContentHider.DAL.Migrations
{
    ...
    [Migration("20231103150840_AddRefreshTokenThingy")]
    partial class AddRefreshTokenThingy
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ContentHider.Core.Daos.RuleDao", b =>
                {
                    ...
                    b.Property<string>("AnonymizedField")
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("ContentHider.Core.Daos.UserDao", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("varchar(255)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ContentHider.Core.Daos.UserDao", null)
                        .WithMany()
